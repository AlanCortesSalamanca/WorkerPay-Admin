...
@Table(name = "advances", indexes = {
    @Index(name = "idx_advances_worker_id", columnList = "worker_id"),
    @Index(name = "idx_advances_status", columnList = "status"),
    @Index(name = "idx_advances_worker_status", columnList = "worker_id,status")
})
